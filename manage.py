...
from members.app import create_app
from members.database import db
from members.settings import DevConfig, ProdConfig
from members.user.models import User

CONFIG = ProdConfig if os.environ.get('MEMBERS_ENV') == 'prod' else DevConfig
